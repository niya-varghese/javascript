...
function validateUser() {
  ...
  var f=ValidateEmail(username);
  if(f==0)
   {
       document.getElementById("msg1").innerHTML+="Invalid id";
...
function register() {
   ...
   if(q==0)
   {
    document.getElementById("msg3").innerHTML+="Invalid username"; 
   }

    var a=ValidateEmail(email);
    if(a==0)
    {
    document.getElementById("msg4").innerHTML+="Invalid user id";
    }
...
function usercontact() 
{
  ...
  var question= document.getElementById('question');
    ...
    if(g==0)
    {
    document.getElementById("msg6").innerHTML+="Invalid username"; 
    }

    var a=ValidateEmail(email);
    if(a==0)
    {
    document.getElementById("msg7").innerHTML+="Invalid user id";
    }

    var d=ValidatePhone(phone);
    if(d==0)
    {
    document.getElementById("msg8").innerHTML+="Invalid phone number";
    }
